...
public class DashboardController {
    ...
    @Operation(
            ...
            description = "Lấy thông tin dashboard. Admin xem tất cả hệ thống, Manager xem cinema mình quản lý. Mặc định lấy dữ liệu 30 ngày gần nhất nếu không truyền thời gian.")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Lấy dashboard của một cinema cụ thể. Admin có thể xem tất cả cinema, Manager chỉ xem cinema mình quản lý.")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<ApiResponseDTO<DashboardResponse>> getCinemaDashboard(
        ...
        log.info("Getting cinema dashboard for cinema: {} with startDate: {}, endDate: {}",
        ...
        DashboardResponse dashboard = dashboardService.getManagerDashboard(cinemaId, startDate, endDate);

        log.info("Cinema dashboard retrieved successfully for cinema: {} and period {} to {}",
                cinemaId, startDate, endDate);
    ...
    @Operation(
            ...
            description = "Lấy dashboard với khoảng thời gian định sẵn: today (hôm nay), week (tuần qua), month (tháng qua), quarter (quý qua), year (năm qua).")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<ApiResponseDTO<DashboardResponse>> getDashboardQuick(
            @Parameter(description = "Khoảng thời gian: today, week, month, quarter, year")
        ...
        switch (period.toLowerCase()) {
            ...
            case "year":
                ...
                break;
            default:
                throw new IllegalArgumentException("Khoảng thời gian không hợp lệ. Sử dụng: today, week, month, quarter, year");
        }
    ...
    @Operation(
            ...
            description = "Lấy thông tin tóm tắt dashboard (chỉ overview data, không có biểu đồ và bảng chi tiết).")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<ApiResponseDTO<DashboardResponse>> getDashboardSummary(
        ...
        DashboardResponse summaryDashboard = DashboardResponse.builder()
                .overview(fullDashboard.getOverview())
                .build();
