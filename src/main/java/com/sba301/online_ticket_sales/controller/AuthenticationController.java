...
public class AuthenticationController {
  ...
  @Operation(
      ...
      description =
          "Gửi mã OTP đến email người dùng để xác nhận đặt lại mật khẩu. Không yêu cầu đăng nhập.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Xác nhận mã OTP đã gửi qua email trong quá trình quên mật khẩu. Không yêu cầu đăng nhập.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Gửi lại mã OTP đến email người dùng trong quá trình quên mật khẩu. Không yêu cầu đăng nhập.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
